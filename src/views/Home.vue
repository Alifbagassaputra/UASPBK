<template>
  ...
  .weather-widget {
    width: 900px; /* Ubah nilai width sesuai dengan kebutuhan */
    padding: 40px;
    border-radius: 20px;
    background-color: #f0f0f032;
    box-shadow: 0px 0px 20px 0px rgba(0, 0, 0, 0.2);
    background-image: url("https://e0.pxfuel.com/wallpapers/556/840/desktop-wallpaper-burung-terbang-di-langit.jpg"); /* Ganti dengan URL gambar latar belakang yang valid */
